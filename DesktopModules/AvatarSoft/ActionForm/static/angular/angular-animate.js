  ...
  .config(['$provide', '$animateProvider', function($provide, $animateProvider) {
    ...
    $provide.decorator('$animate', ['$delegate', '$injector', '$sniffer', '$rootElement', '$timeout', '$rootScope', '$document',
      ...
      return {
         ...
         *
         * @param {dnnsfjQuery/jqLite element} element the element that will be the focus of the enter animation
         * @param {dnnsfjQuery/jqLite element} parentElement the parent element of the element that will be the focus of the enter animation
         * @param {dnnsfjQuery/jqLite element} afterElement the sibling element (which is the previous element) of the element that will be the focus of the enter animation
        ...
        */
         ...
         *
         * @param {dnnsfjQuery/jqLite element} element the element that will be the focus of the leave animation
         * @param {function()=} doneCallback the callback function that will be called once the animation is complete
        */
         ...
         * | 10. The doneCallback() callback is fired (if provided)                                       | class="my-animation"                        |
         *
         * @param {dnnsfjQuery/jqLite element} element the element that will be the focus of the move animation
         * @param {dnnsfjQuery/jqLite element} parentElement the parentElement element of the element that will be the focus of the move animation
         * @param {dnnsfjQuery/jqLite element} afterElement the sibling element (which is the previous element) of the element that will be the focus of the move animation
         * @param {function()=} doneCallback the callback function that will be called once the animation is complete
        */
         ...
         *
         * @param {dnnsfjQuery/jqLite element} element the element that will be animated
