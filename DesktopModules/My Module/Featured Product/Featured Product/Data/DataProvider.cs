...
namespace Christoc.Modules.Featured_Product.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.Featured_Product.Data.SqlDataprovider,Featured_Product";
        ...
        #endregion
        public abstract IDataReader getfeatureditems(string DBAction);
