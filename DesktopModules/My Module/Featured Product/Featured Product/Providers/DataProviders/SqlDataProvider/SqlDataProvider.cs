...
namespace Christoc.Modules.Featured_Product.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "Featured_Product_";
        ...
        #endregion
        public override IDataReader getfeatureditems(string DBAction)
        {
            return SqlHelper.ExecuteReader(ConnectionString, "FeaturedProduct", DBAction);
