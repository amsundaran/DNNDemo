...
namespace Christoc.Modules.Featured_Product
{
    ...
    /// 
    /// Because the control inherits from Featured_ProductSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : Featured_ProductModuleSettingsBase
    {
