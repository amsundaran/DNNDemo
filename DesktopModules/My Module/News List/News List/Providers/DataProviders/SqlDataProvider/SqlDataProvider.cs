...
namespace Christoc.Modules.News_List.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "News_List_";
        ...
        #endregion
        public override IDataReader getNewslist()
        {
            return SqlHelper.ExecuteReader(ConnectionString, "HomeNewslist");
        }
