...
namespace Christoc.Modules.News_List
{
    ...
    /// 
    /// Because the control inherits from News_ListSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : News_ListModuleSettingsBase
    {
