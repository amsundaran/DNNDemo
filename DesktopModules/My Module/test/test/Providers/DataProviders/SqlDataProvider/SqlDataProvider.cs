...
namespace Christoc.Modules.test.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "test_";
        ...
        public override IDataReader GetProductList(int CategoryID, string DBAction)
        {
            return SqlHelper.ExecuteReader(ConnectionString, "CustomBindProductList", CategoryID,DBAction);
