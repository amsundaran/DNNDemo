...
namespace Christoc.Modules.ProductDetails.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.ProductDetails.Data.SqlDataprovider,ProductDetails";
        ...
        public abstract IDataReader GetProductDetail(int ProductID, string DBAction);
