...
namespace Christoc.Modules.ProductDetails.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "ProductDetails_";
        ...
        #endregion
        public override IDataReader GetProductDetail(int ProductID, string DBAction)
        {
            return SqlHelper.ExecuteReader(ConnectionString, "CustomBindProductList", ProductID, DBAction);
