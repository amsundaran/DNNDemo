<%@ Control Language="C#" AutoEventWireup="false" Inherits="DNNInfo.Modules.News.Controls.CPNews" %>
        ...
        <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnSearch">
            <table class="DNNInfo_TableNormal">
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtUserID" runat="server" Width="50"/></td>
                </tr>
                <tr>
                    <td class="DNNInfo_Label"><dnn:Label ID="lblAuthorName" runat="server" /></td>
                    <td><asp:TextBox ID="txtAuthorName" runat="server" /></td>
                    <td class="DNNInfo_Label"><dnn:Label ID="lblAuthorEmail" runat="server" /></td>
                    <td><asp:TextBox ID="txtAuthorEmail" runat="server" /></td>
                </tr>
                <tr>
                    <td class="DNNInfo_Label"><dnn:Label ID="lblFeatured" runat="server" /></td>
                    <td><asp:Dropdownlist ID="ddFeatured" runat="server"/></td>
            ...
            <Columns>
                ...
                <asp:TemplateField>         
                     <ItemTemplate>
                        ...
                        <div class="DNNInfo_DateIcon"><asp:Literal ID="litGridExpiredDate" runat="server" /></div>
                     </ItemTemplate>
                </asp:TemplateField> 
                <asp:TemplateField>         
                     <ItemTemplate>
                        <div class="DNNInfo_Value"><asp:Literal ID="litGridFeatured" runat="server" /></div>
