<%@ Control Language="C#" AutoEventWireup="false" Inherits="DNNInfo.Modules.News.Controls.CPLicense" %>
...
<div class="DNNInfo_Box">
    ...
    <div class="DNNInfo_BoxInside">
        ...
        <asp:Panel ID="pnlLicense" runat="server">
            ...
            <asp:Button ID="btnGetLicense" runat="server" CssClass="DNNInfo_Button" />
        </asp:Panel>
    </div>
</div>
