<%@ Control Language="C#" AutoEventWireup="false" Inherits="DNNInfo.Modules.News.Controls.AuthorEditNews" %>
...
<div class="DNNInfo_Box">
    <div class="DNNInfo_BoxHeader"><dnn:Label ID="lblEditArticle" runat="server" /></div>
    <div class="DNNInfo_BoxInside">
        ...
        <table class="DNNInfo_TableNormal" cellpadding="0" cellspacing="0">
            ...
            <tr id="trAuthorOtherName" runat="server">
            ...
            <tr>
                <td></td>
                <td><asp:Button ID="btnUpdate" runat="server" CssClass="DNNInfo_Button" ValidationGroup="NewsForm"/> <asp:Button ID="btnUpdateReturn" runat="server" CssClass="DNNInfo_Button" ValidationGroup="NewsForm"/> <asp:Button ID="btnCancel" runat="server" CssClass="DNNInfo_Button" CausesValidation="false"/>
